...
/**
 * Implements the VenueSearchListener and registers itself with the DataManager
 * Also have to unregister your VenueListFragment in onStop so the DataManager
 * does not try to notify it after the fragment has been stopped
 */
public class VenueListFragment extends Fragment implements VenueSearchListener {
    ...
    //Get the data when the list is ready
    //Hook it into the adapter to update it
    @Override
